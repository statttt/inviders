    ...
    Pass {   
        ...
        uniform half _ScaleY;
         ...
         half4 frag(vertexOutput input) : COLOR
         {
            ...
            tempcol = tex2D(_Texture,half2(input.uv.x * _ScaleX, input.uv.y * _ScaleY)).rgb * tempcol;

            half3 finalColor = lerp(unity_FogColor.rgb, tempcol.rgb, input.fogColorFactor.x) * _Brightness;
